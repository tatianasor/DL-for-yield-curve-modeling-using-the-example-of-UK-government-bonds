...
MODEL_NAME = "AE_2020-2021"

# -----------------------------
# 1. LOAD DATA
# -----------------------------
train = pd.read_csv("UK_yield_curve_daily_processed_2020-2021_train.csv")
val = pd.read_csv("UK_yield_curve_daily_processed_2020-2021_val.csv")
test = pd.read_csv("UK_yield_curve_daily_processed_2020-2021_test.csv")
...
# (уже режим 2020-2021 — но оставляем безопасность)
...
print("\n=== STATIC FORECAST (2020-2021 REGIME) ===")
print(static_df)
...
print("\nDONE: AE_2020-2021 full pipeline saved")