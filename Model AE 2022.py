...
# 1. LOAD DATA
# -----------------------------
train = pd.read_csv("UK_yield_curve_daily_processed_2022_train.csv")
val = pd.read_csv("UK_yield_curve_daily_processed_2022_val.csv")
test = pd.read_csv("UK_yield_curve_daily_processed_2022_test.csv")
...
# (уже режим до 2022 — но оставляем безопасность)
...
print("\nDONE: AE_2022 full pipeline saved")